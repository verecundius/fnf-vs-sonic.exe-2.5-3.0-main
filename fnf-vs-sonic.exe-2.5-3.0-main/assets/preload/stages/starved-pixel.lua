...
function onUpdate()
	if curBeat < 32 and songName == 'prey-remix' then
...
function onBeatHit()
	if curBeat % 8 == 0 and songName == 'prey-remix' then
		if curBeat < 32 then
...
function onStepHit()
	if curStep == 250 and songName == 'prey-remix' then
